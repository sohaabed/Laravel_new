        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-3 col-md-4">
                    ...
                    @else
                    <a href="{{route('user.home.')}}" style="color:red"> Go to your panel  <i class="fas fa-arrow-right"></i>  </a>
            ...
            <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    ...
                    <div class="social ml-auto">
                       ...
                       <a href="{{route('user.home.')}}" class="sign" style="width:120px;color:white;">Your Panel</a>
                       @endif
                       @endauth
                       <a href=""><i class="fab fa-twitter"></i></a>
                        ...
                        <a href="#" class="sign" style="width:70px;color:white;" onclick="document.querySelector('.logout').submit()">Log out</a>
                       
                        
                    <span style="    font-size: 20px; font-weight: 800;color: white;margin-left:10px" >  Hi | {{Auth::user()->name}}</span>
