                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div>
                                <a href="{{route('admin.admin_content.create')}}" class="add btn btn-info font-bold " style="font-size:x-large;opacity: 70% !important;text-align:center">Add New
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style=" line-height: 121px;">
                                                <a href="{{route('admin.admin_content.edit',$content->id)}}"><span class="material-icons btn btn-primary " style=" margin-right: 20px; font-size: large;opacity: 80%">mode_edit</span></a>

                                                <form action="{{route('admin.admin_content.delete',$content->id)}}" method="post" style="display: inline;">
                                                    @csrf
                                                    @method('delete')
