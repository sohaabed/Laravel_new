...
class AdminContentsController extends Controller
{
    public function index(Request $request)
    {
       ...
       $contents  =  User::find($user_id)->contents()->when($request->search, function ($query, $value) {
        ...
        return view('admin.admin_content.index', [
            'contents' => $contents,
    ...
    {
        return view('admin.admin_content.create', [
            'content' => new Content(),
            'categories' => Category::all()
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.admin_content.index')->with(
            "success",
    ...
    public function edit($id)
    {
        ...
        return view('admin.admin_content.edit', [
            "content" => $content,
            'categories' => Category::all()
        ]);
    }
